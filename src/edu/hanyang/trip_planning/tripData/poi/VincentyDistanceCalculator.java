...
class Position {
    ...
    public double getGeocentricLat() {
        ...
        double dtheta = f1 * sin(2 * latitudeR) - f2 * sin(4 * latitudeR);
        return latitudeR - dtheta;
    }
...
final class Distance {
    ...
    public static String formatNm(double m) {
        floatFormat.setMaximumFractionDigits(1);
...
final class Vector {
    ...
    public static void main(String[] args) {
        System.out.println(" = " + VincentyDistanceCalculator.getDistance(37.644633, 127.051383, 37.555716, 127.04364));
    }
}
