 ...
 */
public class GenerateMapPathHTML {
...
//                break;
    ...
    public String generateMapHTMLStr(){
        ...
        for (String text: textList){
            strbuf.append("<p>" + text + "</p>\n");
        }

        strbuf.append(detailText);
        strbuf.append(closeStr);
        return strbuf.toString();
    }
...
//        System.out.println(gen.generateMapHTMLStr());
    ...
    public static void test1(){
        ...
        GenerateMapPathHTML generateHTML = new GenerateMapPathHTML();
        generateHTML.addMarkers(strs);
