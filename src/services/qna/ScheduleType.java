...
public enum ScheduleType {
    ...
    SingleEventRestOrSleep("휴식/잠"),SingleEventLunch("점심식사"),SingleEventDinner("저녁식사"),
    SingleEventShortMeeting("짧은회의"), SingleEventLongMeeting("긴회의"),
    Travel("여행"),
    ...
    MultiDayWorkshop("여러날워크숍"), OneDayWorkshop("당일워크숍"),
