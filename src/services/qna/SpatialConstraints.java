...
public class SpatialConstraints {
    ...
    public boolean isEmpty() {
        return symbolicSpatialConstraints.size() == 0 && metricSpatialConstraints.size() == 0;
    }
    ...
    public static SpatialConstraints dummy2() {
        ...
        SpatialStatementByLocation spatialStatementByPOI = new SpatialStatementByLocation("한양대학교", 3);
