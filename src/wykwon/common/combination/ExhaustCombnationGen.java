...
public class ExhaustCombnationGen implements CombGen {
    private int n, r;
    private int[] index;
    private boolean hasNext = true;
    private static Logger logger = Logger.getLogger(ExhaustCombnationGen.class);

    public ExhaustCombnationGen(int n, int r) {
        this.n = n;
        this.r = r;
        index = new int[r];
    ...
    public static void main(String[] args) {
        ExhaustCombnationGen comb = new ExhaustCombnationGen(6, 3);
        while (comb.hasNext()) {
            System.out.println(Arrays.toString(comb.next()));
        }
    }
}
